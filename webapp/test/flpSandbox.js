			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"qrcode-display": {
								"semanticObject": "qrcode",
								"action": "display",
								"description": "QR Code Printing in Local JSON Model",
								"title": "QR Code Printing",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=qrcode",
									"url": sap.ui.require.toUrl("qrcode")
								}
							}
						}
					}
